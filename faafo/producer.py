...
class ProducerService(service.Service, periodic_task.PeriodicTasks):
    def __init__(self):
        ...
        self.notifier = messaging.Notifier(self.transport, topic="tasks")
        publisher_id = "producer-%d" % id(self)
        self.subnotifier = self.notifier.prepare(publisher_id=publisher_id)
        ...
        def generate_task(self, ctxt):
            ...
            for i in xrange(0, number):
                ...
                self.subnotifier.info(ctxt, 'task', task)
